...
### Technology and Skills
 ...
 `r icons::octicons$terminal`: **Misc.** Experience high performance computing (<span style="color:red;">`bash`, `slurm`</span>), virtual environments (<span style="color:red;">`conda`, `singularity`, `docker`</span>), version control (<span style="color:red;">`git`</span>), literate programming (<span style="color:red;">`Rmarkdown`, `Jupyter`</span>).
...
- Coordinated adaptation of lab curriculum to be fully online due to Covid-19. 
...
- **Developed and deployed statistics web application used by >=705 students** as of 2021 using `shiny` [source](https://github.com/danielkick/MultiMethodPhysApp) , [deployed](https://danielkick.shinyapps.io/BioSc3700_1).
  - Includes capability for visualization, testing model assumptions, **frequentist** models, **non-parametric** tests, basic **Bayesian** models.
...
ASA, CSSA and SSSA International Annual Meetings, Baltimore MD
