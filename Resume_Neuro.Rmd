...
### Technical Skills
 ...
 `r icons::octicons$terminal`: **Other Technical **
 Experience with high performance computing, virtual environments, version control (<span style="color:DarkRed;">`git`, `GitHub`</span>), literate programming.
...
- Interdisciplinary scientist with experience in **neuroscience, electrophysiology, statistics, programming, machine learning, and deep learning**.
- **Developed NIFA funded research plan** ([Grant 2023-67012-39485](https://portal.nifa.usda.gov/web/crisprojectpages/1030152-environmentally-aware-deep-learning-based-genomic-selection-and-management-optimization-for-maize-yield.html)).
- **Collaborated** with persons from diverse specializations including computational neuroscience, electrophysiology, and bioinformatics.
...
--------------------------------------------------------------------------------
### Research Geneticist (Deep Learning, Machine Learning)
...
- **Mentored** `r postdoc_mentoring` students conducting a high throughput phenotyping experiment. 
...
### Graduate Researcher (Molecular Neurophysiology)
...
- **Developed novel approaches to quantify changes in cell activity**.
