...
- **Secured $225,000** to develop **"Environmentally Aware Deep Learning Based Genomic Selection And Management Optimization For Maize Yield"** from the National Institute of Food and Agriculture.
...
- **Mentored 5 `r phd_mentoring` students** and oversaw their projects. 
...
Selected Publications (Showing `r resume_frac(get_section = 'academic_articles')` Published, `r resume_frac(get_section = 'academic_articles_review')` in Review, 0/`r resume_frac(get_section = 'academic_articles_prep', half = T)` in Prep.) {data-icon=flask}
--------------------------------------------------------------------------------
```{r}
...
<font size="1">***Daniel R. Kick***, Jacob D. Washburn ([$bioR \chi iv$](https://www.biorxiv.org/content/10.1101/2023.03.30.532932v1)) In Review at *In silico Plants*</font>
