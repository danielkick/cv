...
## Technical Skills
 ...
 `r icons::fontawesome$solid$flask`: **Neuroscience Research **
 
 Experience with **multimodal datasets** (<font size=-2>single cell mRNA expression, ionic conductances, and excitability</font>), experimental design, electrophysiology techniques (<font size=-2>dynamic, voltage, & current clamp</font>), **creating custom data processing workflows**.
