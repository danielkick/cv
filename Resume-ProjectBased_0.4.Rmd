...
- Adaptable interdisciplinary scientist with 8 years of experience in academic and government laboratories.
- **statistical modeling, machine learning, deep learning**, experimental design and execution, and data visualization & communication.
...
Selected Refereed Publications {data-icon=flask}
--------------------------------------------------------------------------------
```{r}
...
- Evaluated **deep neural networks, machine learning models,** and **best linear unbiased predictors** to **improve yield prediction accuracy** in diverse environments (**Publication in review**). 
...
- Completed **Software Carpentries instructor certification**. 
- Taught **`R` for Reproducible Scientific Analysis**, assisted in teaching **Data Management with `SQL`**.
...
- **Developed and deployed statistics web application used by more than 700 students** as of 2021 using `shiny` ( [source](https://github.com/danielkick/MultiMethodPhysApp) , [deployed](https://danielkick.shinyapps.io/BioSc3700_1)). Application includes visualization, testing model assumptions, **frequentist** models, **non-parametric** tests, basic **Bayesian** models.
...
- Measured effectiveness of oligonucleotide treatment for spinal muscular atrophy in mice <font size="1">-- (NSF REU) Christian Lorson, University of Missouri (2013)</font>
