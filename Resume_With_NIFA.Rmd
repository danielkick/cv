...
- **Presented** to scientific and general audiences over **25 times** since 2016. 
...
- [Employed **deep neural networks, machine learning models,** and **best linear unbiased predictors** to **improve corn yield prediction accuracy** in diverse environments](https://academic.oup.com/g3journal/advance-article/doi/10.1093/g3journal/jkad006/6982634).
- **Secured $225,000 in funding** over two years to develop "Environmentally Aware Deep Learning" through a NIFA fellowship.
- **Communicated** with stakeholders (**9 presentations**: <font size="1">5 national, 2 regional, 2 outreach)</font>. 
- **Mentored** 2 students, wrote scripts for data analysis of high throughput root phenotyping experiment.
- **Created** and taught a **Python data visualization workshop**: "Tools and Techniques for a Jupyter Based Scientific Workflow".
- **Collaborated with plant biologists**, contributing statistical expertise.
...
Honors and Awards (4/5) {data-icon=award}
--------------------------------------------------------------------------------


### NIFA Fellowship (AFRI EWD)

**$225,000** awarded over two years to create and environmentally aware deep learning genomic selection models and develop professionally to transition into industry [Grant Number 2023-67012-39485](https://portal.nifa.usda.gov/lmd4/recent_awards?report_title=Recent%20Awards&from_site=NIFA&search_label=Awards%20Listing)
...
Selected Publications (3/7 Published, 2 in Review, 2 in Prep.) {data-icon=flask}
--------------------------------------------------------------------------------
```{r}
...
<font size="1">***Daniel R. Kick***, Jacob D. Washburn (In Review)  [$bioR \chi iv$](https://www.biorxiv.org/content/10.1101/2023.03.30.532932v1)</font>
